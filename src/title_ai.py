...
def generate_title_description_tags(topic, script):
    ...
    try:
        ...
        try:
            ...
            return f"Mystery: {topic}", "A mysterious video from svifi mystery channel.", ["mystery", "svifi mystery"]

    except requests.exceptions.RequestException as e:
        print(f"Error generating title, description, tags with Gemini: {e}")
        return f"Mystery Video: {topic}", "A mysterious video from svifi mystery channel.", ["mystery", "svifi mystery"]
